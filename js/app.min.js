    ...
    var o = {
        ...
        carousel: function() {
            n(".testi-carousel").owlCarousel({
                ...
                dotSpeed: 2000,
                autoplay: !0,
                autoplayTimeout: 8000, // Testimonial display duration set to 10 seconds
                autoplaySpeed: 1000,
                items: 1
					...
					margin: 10,
					nav: true,
					navSpeed: 500, // Speed of manual navigation
					dots: false,
					autoplay: true,
					autoplaySpeed: 1000, // Speed of the autoplay transition
					autoplayTimeout: 1000, // Minimum delay between transitions
					slideTransition: 'linear', // Linear transition for smooth continuous flow
                ...
                return n(this).waypoint({
                    handler: function(e) {
                        n(".progress").each(function() {
                            console.log(n(this).attr("data-percent")), n(this).find(".progress-bar").delay(10000).css({
